...
<div class="py-2">
    <label class="block text-sm text-gray-600" for="available">
        <input id="available" name="available" type="checkbox" aria-label="available" value="1" @checked($course->available ?? false)>    
        Disponível
    </label>
</div>
<div class="mt-2">
...
<div class="mt-2">
    ...
    <textarea class="w-full px-5 py-2 text-gray-700 bg-gray-200 rounded" name="description" id="description" cols="30" rows="4" placeholder="Descrição">{{ $course->description ?? old('description') }}</textarea>
</div>
<div class="mt-6">
